...
import { motion } from 'framer-motion'; // DODATO: Bez ovoga sajt pobeli!
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#03040b] px-4">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-white/10 backdrop-blur-2xl p-10 rounded-[40px] border border-white/20 w-full max-w-md shadow-2xl">
          <h2 className="text-white text-2xl font-black mb-8 text-center uppercase tracking-widest text-cyan-400">Admin Login</h2>
        ...
        <div className="bg-white/5 backdrop-blur-3xl p-8 rounded-[40px] border border-white/10 shadow-2xl mb-16 text-left">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="bg-cyan-500/5 border-2 border-dashed border-cyan-500/20 p-8 rounded-3xl text-center">
              ...
              {uploading && <p className="text-cyan-400 text-[10px] mt-4 animate-pulse">Slanje...</p>}
            </div>
            ...
            <button type="submit" className="w-full bg-cyan-500 p-5 rounded-2xl font-black text-black uppercase tracking-widest hover:bg-cyan-400 transition-all">Objavi na sajt</button>
          </form>
        </div>
