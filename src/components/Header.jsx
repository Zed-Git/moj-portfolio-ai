...
import { FaLinkedin, FaXTwitter } from 'react-icons/fa6'; // Koristimo novu X ikonicu

const Header = () => {
  // OVDE STAVI SVOJE PRAVE LINKOVE
  const socialLinks = {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-[100] bg-[#03040b]/80 backdrop-blur-xl border-b border-white/5 py-4 px-6 md:px-16 flex justify-between items-center shadow-2xl">
      ...
      <a href="#home" className="flex items-center gap-3 hover:opacity-80 transition-all">
      ...
      <nav className="flex items-center gap-8">
        <ul className="hidden md:flex items-center gap-6 text-[13px] font-bold uppercase tracking-widest">
