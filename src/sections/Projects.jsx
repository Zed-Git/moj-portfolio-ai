              ...
              <Link to={`/project/${project.id}`}>
                <div className="aspect-video overflow-hidden bg-slate-900">
                  {project.slika_url ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center text-slate-700 uppercase text-[10px] tracking-widest italic font-sans text-center">No image available</div>
                  )}
                </div>
